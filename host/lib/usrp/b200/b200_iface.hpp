...
enum b200_product_t { B200, B210, B200MINI, B205MINI, B205MINI_PLUS, B205MINI_75T, B205MINI_100T, B210_PLUS};
...
const static uint16_t B205MINI_PLUS_PRODUCT_ID = 0x0023;
const static uint16_t B205MINI_75T_PRODUCT_ID = 0x0024;
const static uint16_t B205MINI_100T_PRODUCT_ID = 0x0025;
const static uint16_t B210_PLUS_PRODUCT_ID = 0x0026;
...
static const uhd::dict<uint16_t, b200_product_t> B2XX_PID_TO_PRODUCT =
    boost::assign::map_list_of(B200_PRODUCT_NI_ID, B200)(B210_PRODUCT_NI_ID, B210)(
        B200MINI_PRODUCT_ID, B200MINI)(B205MINI_PRODUCT_ID, B205MINI)(B205MINI_PLUS_PRODUCT_ID, B205MINI_PLUS)(
            B205MINI_75T_PRODUCT_ID, B205MINI_75T)(B205MINI_100T_PRODUCT_ID, B205MINI_100T)
            (B210_PLUS_PRODUCT_ID, B210_PLUS);
...
static const uhd::dict<uint16_t, b200_product_t> B2XX_PRODUCT_ID =
    boost::assign::map_list_of(0x0001, B200)(0x7737, B200)(B200_PRODUCT_NI_ID, B200)(
        ...
        0x7739, B200MINI)(0x0004, B205MINI)(0x773a, B205MINI)(0x0005, B205MINI_PLUS)(0x773b, B205MINI_PLUS)
        // b205mini_plus should has different 0x773b, need to research more. TODO
        (0x0006, B205MINI_75T)(0x773c, B205MINI_75T)(0x0007, B205MINI_100T)(0x773d, B205MINI_100T)
        (0x0008, B210_PLUS)(0x773e, B210_PLUS);
...
static const uhd::dict<b200_product_t, std::string> B2XX_STR_NAMES =
    boost::assign::map_list_of(B200, "B200")(B210, "B210")(B200MINI, "B200mini")(
        B205MINI, "B205mini")(B205MINI_PLUS, "B205mini_plus")(B205MINI_75T, "B205mini_75t")(B205MINI_100T, "B205mini_100t")
        (B210_PLUS, "B210_plus");
...
static const uhd::dict<b200_product_t, std::string> B2XX_FPGA_FILE_NAME =
    boost::assign::map_list_of(B200, "usrp_b200_fpga.bin")(B210, "usrp_b210_fpga.bin")(
        B200MINI, "usrp_b200mini_fpga.bin")(B205MINI, "usrp_b205mini_fpga.bin")(B205MINI_PLUS, "usrp_b205mini_plus_fpga.bin")
        (B205MINI_75T, "usrp_b205mini_75t_fpga.bin")(B205MINI_100T, "usrp_b205mini_100t_fpga.bin")(B210_PLUS, "usrp_b210_plus_fpga.bin");
        //FPGAbin文件名暂定。还需要再根据实际文件名修改
